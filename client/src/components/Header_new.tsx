...
import { Map, Award, BookOpen, GraduationCap, Menu, User, Image, Crown, Languages } from "lucide-react";
    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <button 
          ...
          className="flex items-center justify-center space-x-2 bg-white/90 text-gray-700 py-1.5 px-4 rounded-full shadow-sm hover:bg-white transition-colors duration-200 border border-gray-200 mr-4"
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {t("Участник с", "Member since")} {user?.joinDate || t("Сегодня", "Today")}
                  </p>
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <span className={`text-xs font-bold ${getLevelColor(user?.level || 1)}`}>
                      {t("Уровень", "Level")} {user?.level || 1}
                    </span>
                  </div>
                </div>
              </div>
      ...
      <Dialog open={avatarDialogOpen} onOpenChange={setAvatarDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{t("Выберите аватар", "Choose Avatar")}</DialogTitle>
            <DialogDescription>
              {t("Персонализируйте свой профиль, выбрав аватар из доступных вариантов.", 
                 "Personalize your profile by choosing an avatar from available options.")}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 text-sm text-gray-500">
            {t("Продолжайте зарабатывать очки, чтобы разблокировать больше аватаров!", 
               "Keep earning points to unlock more avatars!")}
          </div>
        </DialogContent>
      </Dialog>
    </header>
